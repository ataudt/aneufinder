...
#' @author Aaron Taudt
#' @export
variableWidthBins <- function(reads, binsizes, chromosomes=NULL, assembly=NULL) {
	...
	binned.list <- suppressMessages( binReads(reads, format='GRanges', assembly=assembly, binsizes=binsizes, calc.complexity=FALSE, chromosomes=chromosomes) )
	stopTimedMessage(ptm)
